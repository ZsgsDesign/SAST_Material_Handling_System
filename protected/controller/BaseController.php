...
class BaseController extends Controller
{
    ...
    public function init()
    {
        ...
        $this->MHS_DOMAIN=CONFIG::GET("MHS_DOMAIN");
        $this->MHS_CDN=CONFIG::GET("MHS_CDN");
        if (isset($_SERVER["HTTP_MHS_DOMAIN"])) {
            $this->MHS_DOMAIN=$_SERVER["HTTP_MHS_DOMAIN"];
        }
        if (isset($_SERVER["HTTP_MHS_STATIC"])) {
            $this->MHS_CDN=$_SERVER["HTTP_MHS_STATIC"];
        }
