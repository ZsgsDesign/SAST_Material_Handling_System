...
CREATE TABLE `order`  (
  ...
  `return_time` datetime NULL COMMENT '物品实际归还的时间或订单被取消的时间',
  `renter_checked` tinyint(20) NULL DEFAULT NULL COMMENT '用于记录借用人是否已知晓当前订单状态',
  `owner_checked` tinyint(20) NULL COMMENT '用于记录出借人是否已知晓当前订单状态',
